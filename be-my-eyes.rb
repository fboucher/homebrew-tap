class BeMyEyes < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/fboucher/be-my-eyes/releases/download/v0.1.11/be-my-eyes_0.1.11_darwin_arm64.tar.gz"
    else
      url "https://github.com/fboucher/be-my-eyes/releases/download/v0.1.11/be-my-eyes_0.1.11_darwin_amd64.tar.gz"
    end
  end
